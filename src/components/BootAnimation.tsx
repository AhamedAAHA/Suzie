        ...
        <AnimatePresence mode="wait">
          {phase === "listen" && (
            ...
            >
              ...
              <motion.button
                onClick={() => handleWake("clap")}
                className="px-6 py-2.5 rounded-lg border border-cyan-400/40 text-cyan-400 font-semibold text-sm tracking-wider hover:bg-cyan-400/10 transition-all"
